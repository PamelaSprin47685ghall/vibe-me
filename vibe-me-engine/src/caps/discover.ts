...
export async function tryReadFile(filePath: string, label: string): Promise<CapsFileInfo | undefined> {
  try {
...
export async function discoverFilesInDir(dirPath: string, out: string[], depth: number, visited: Set<string>): Promise<void> {
