...
const TaskToolAgentArgsSchema = z
  .object({
    ...
    experiments: z
      .object({
        programmaticToolCalling: z.boolean().nullish(),
        programmaticToolCallingExclusive: z.boolean().nullish(),
        advisorTool: z.boolean().nullish(),
        execSubagentHardRestart: z.boolean().nullish(),
        addonLaunch: z.object({ squad: z.string().nullish() }).nullish(),
        toolPolicy: z.object({ disabledTools: z.array(z.string()) }).nullish(),
      })
      .passthrough()
      .nullish()
